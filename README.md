...
- 3 custom programming languages: `X#`, `X++`, and `XAsm`.
...
- I participated in OSWars25 as the leader of [@-EmeraldOS25-](https://scratch.mit.edu/users/-EmeraldOS25-/) and am planning to lead [@XenonOS26](https://scratch.mit.edu/users/XenonOS26/) in the next iteration.
